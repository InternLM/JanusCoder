...
def llm_edit_judge(original_image, edited_image, instruction):
    ...
    # gpt-4o-2024-11-2
    response = gpt_edit_judge(model_name="gpt-4o", original_image=original_image, edited_image=edited_image, prompt=prompt)
    return response
...
def llm_repair_judge(original_image, repaired_image, reference_image, issues):
    ...
    response = gpt_repair_judge(model_name="gpt-4o", original_image=original_image,
    ...
    response = openai_client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": [
                ...
                {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{original_image}", "detail": "high"}},
                {"type": "image_url", "image_url": { "url": f"data:image/jpeg;base64,{edited_image}", "detail": "high"}},
            ],
            }
        ],
        max_tokens=4096,
    ...
    response = openai_client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": [
                {"type": "text", "text": prompt},
                {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{original_image}","detail": "high"}},
                {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{repaired_image}", "detail": "high"}},
                {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{reference_image}", "detail": "high"}},
            ],
            }
        ],
        max_tokens=4096,
