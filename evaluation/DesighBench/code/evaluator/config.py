...
DesignBench_Path = "/cpfs01/shared/XNLP_H800/sunqiushi/MCLM/eval-pack/DesignBench/"
...
clip_path = "/cpfs01/shared/XNLP_H800/hf_hub/clip-vit-base-path32"
...
# }
folder_dic = {
    Task.GENERATION: DesignBench_Path + "results/generation/",
    Task.EDIT: DesignBench_Path + "results/edit/",
    Task.REPAIR: DesignBench_Path + "results/repair/",
}
