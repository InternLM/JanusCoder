...
class LocalServerEngine(BaseOpenAIImageEngine, BaseOpenAIEngine):
    def __init__(
        self,
        model_name,
        ...
        super().__init__(
            'InternVL3_5-4B-HF', system_prompt, add_args, wait_time, attempts, api_key_name
        )
        self.name = model_name
        # self.model_url = "http://35.220.164.252:3888/v1/"
        self.model_url = "http://10.130.128.31:8994/v1/"
